...
To use it in your local machine. You will need to download Tomcat v9.0 server and MAMP (or any program that allows you to install a local server environment on your computer). Connect to the server in your IDE, and connect to Apache Server and MySQL server in MAMP, and in your browser, type in http://localhost:8080/Jupiter/ (or your specified port number). Then you will see the page.
for test you will need Postman.
